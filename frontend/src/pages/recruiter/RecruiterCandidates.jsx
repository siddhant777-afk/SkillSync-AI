...
const FALLBACK_BENCHMARKS = [
  {
    id: 100,
    name: "Subhi Sharma",
    email: "subhi.sharma@glbajaj.org",
    ...
    platformBreakdown: {
      leetcode: {
        ...
        advancedTopicsSolved: 92,
        verified: true,
        profileUrl: "https://leetcode.com/u/subhi_coder",
      },
      codeforces: {
        platform: "Codeforces",
        handle: "subhi_sharma",
        ...
        solved: 120,
        verified: true,
        profileUrl: "https://codeforces.com/profile/subhi_sharma",
      },
      codechef: {
        platform: "CodeChef",
        handle: "subhi_cc",
        ...
        solved: 40,
        verified: true,
        profileUrl: "https://www.codechef.com/users/subhi_cc",
      },
      github: {
        platform: "GitHub",
        handle: "subhi-dev",
        ...
        verified: true,
        profileUrl: "https://github.com/subhi-dev",
      },
    },
  },
  {
    ...
    platformBreakdown: {
      leetcode: {
        ...
        handle: "aarav_g",
        contestRating: 1680,
        contestBadge: "Specialist",
        solved: 580,
        advancedTopicsSolved: 85,
        verified: true,
        profileUrl: "https://leetcode.com/u/aarav_g",
      },
      codeforces: {
        platform: "Codeforces",
        handle: "aarav_coder",
        ...
        solved: 110,
        verified: true,
        profileUrl: "https://codeforces.com/profile/aarav_coder",
      },
      codechef: {
        platform: "CodeChef",
        handle: "aarav_dtu",
        ...
        solved: 0,
        verified: true,
        profileUrl: "https://www.codechef.com/users/aarav_dtu",
      },
      github: {
        platform: "GitHub",
        handle: "aarav-g",
        ...
        verified: true,
        profileUrl: "https://github.com/aarav-g",
      },
    },
  },
  {
    ...
    platformBreakdown: {
      leetcode: {
        ...
        advancedTopicsSolved: 72,
        verified: true,
        profileUrl: "https://leetcode.com/u/priya_ai",
      },
      codeforces: {
        platform: "Codeforces",
        handle: "priya_m",
        ...
        solved: 90,
        verified: true,
        profileUrl: "https://codeforces.com/profile/priya_m",
      },
      codechef: {
        platform: "CodeChef",
        handle: "priya_cc",
        ...
        solved: 0,
        verified: true,
        profileUrl: "https://www.codechef.com/users/priya_cc",
      },
      github: {
        platform: "GitHub",
        handle: "priya-m",
        ...
        verified: true,
        profileUrl: "https://github.com/priya-m",
      },
    },
  },
  {
    ...
    platformBreakdown: {
      leetcode: {
        ...
        advancedTopicsSolved: 55,
        verified: true,
        profileUrl: "https://leetcode.com/u/rohan_cloud",
      },
      codeforces: {
        platform: "Codeforces",
        handle: "rohan_d",
        ...
        solved: 80,
        verified: true,
        profileUrl: "https://codeforces.com/profile/rohan_d",
      },
      codechef: {
        platform: "CodeChef",
        handle: "rohan_cc",
        ...
        solved: 0,
        verified: true,
        profileUrl: "https://www.codechef.com/users/rohan_cc",
      },
      github: {
        platform: "GitHub",
        handle: "rohan-cloud",
        ...
        verified: true,
        profileUrl: "https://github.com/rohan-cloud",
      },
    },
  },
];

const filterAndSortCandidates = (list, filters) => {
  return list
    .filter((c) => {
      if (filters.role && !c.careerGoal?.toLowerCase().includes(filters.role.toLowerCase()) && !c.sector?.toLowerCase().includes(filters.role.toLowerCase())) {
        return false;
      }
      if (filters.college && !c.college?.toLowerCase().includes(filters.college.toLowerCase().replace(/institute.*/i, "gl bajaj").trim())) {
        return false;
      }
      if (filters.minScore && (c.placementReadiness || 0) < filters.minScore) {
        return false;
      }
      if (filters.minLeetcode && (c.leetcodeSolved || 0) < filters.minLeetcode) {
        return false;
      }
      if (filters.minAdvanced && (c.advancedTopicsSolved || c.dpSolved || 0) < filters.minAdvanced) {
        return false;
      }
      if (filters.skill && !c.skills?.some((s) => s.toLowerCase().includes(filters.skill.toLowerCase()))) {
        return false;
      }
      return true;
    })
    .sort((a, b) => {
      // 5-Tier Priority Sort
      if ((b.maxContestRating || 0) !== (a.maxContestRating || 0)) {
        return (b.maxContestRating || 0) - (a.maxContestRating || 0);
      }
      if ((b.totalQuestionsSolved || 0) !== (a.totalQuestionsSolved || 0)) {
        return (b.totalQuestionsSolved || 0) - (a.totalQuestionsSolved || 0);
      }
      if ((b.achievementsCount || 0) !== (a.achievementsCount || 0)) {
        return (b.achievementsCount || 0) - (a.achievementsCount || 0);
      }
      if ((b.projectsCount || 0) !== (a.projectsCount || 0)) {
        return (b.projectsCount || 0) - (a.projectsCount || 0);
      }
      if ((b.commitsCount || 0) !== (a.commitsCount || 0)) {
        return (b.commitsCount || 0) - (a.commitsCount || 0);
      }
      return (b.placementReadiness || 0) - (a.placementReadiness || 0);
    });
};
  ...
  const fetchCandidates = async () => {
    ...
    try {
      ...
      if (Array.isArray(data) && data.length > 0) {
        ...
        setCandidates(filterAndSortCandidates(FALLBACK_BENCHMARKS, filters));
      }
    } catch {
      setCandidates(filterAndSortCandidates(FALLBACK_BENCHMARKS, filters));
    } finally {
      ...
      <div className="grid gap-3 sm:gap-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 sm:p-5 shadow-xs grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 min-w-0">
        ...
        <div>
          <div className="flex items-center justify-between">
            <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">College / University</label>
            {filters.college && (
              <button
                type="button"
          ...
          <input
            ...
            className="mt-1 w-full rounded-xl border border-slate-200 dark:border-slate-750 bg-white dark:bg-slate-850 px-3 py-2 text-xs text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 outline-none focus:border-indigo-500"
          />
          ...
          <button
            ...
            className="mt-1 text-[10px] font-semibold text-indigo-700 dark:text-indigo-300 bg-indigo-50 dark:bg-indigo-950/60 hover:bg-indigo-100 dark:hover:bg-indigo-900/60 rounded px-1.5 py-0.5 border border-indigo-200 dark:border-indigo-800 transition block truncate"
          >
